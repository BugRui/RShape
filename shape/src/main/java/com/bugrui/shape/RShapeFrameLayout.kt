...
class RShapeFrameLayout @JvmOverloads constructor(
    ...
    init {
        ...
        val shapeBgColor = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlBgColor, DEF_VALUE_INT)
        val shapeStrokeSize = typedArray.getInt(R.styleable.RShapeFrameLayout_shapeFlStrokeSize, DEF_VALUE_INT)
        val shapeStrokeColor = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlStrokeColor, DEF_VALUE_INT_0)
        ...
        val shapeGradientColor1 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor1, DEF_VALUE_INT)
        val shapeGradientColor2 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor2, DEF_VALUE_INT)
        val shapeGradientColor3 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor3, DEF_VALUE_INT)
        val shapeGradientColor4 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor4, DEF_VALUE_INT)
        val shapeGradientColor5 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor5, DEF_VALUE_INT)
        val shapeGradientColor6 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor6, DEF_VALUE_INT)
        val shapeGradientColor7 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor7, DEF_VALUE_INT)
        val shapeGradientColor8 = typedArray.getColor(R.styleable.RShapeFrameLayout_shapeFlGradientColor8, DEF_VALUE_INT)
