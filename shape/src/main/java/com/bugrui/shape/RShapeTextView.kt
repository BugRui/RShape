 ...
 * @Version:        1.0
 */
class RShapeTextView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        val shapeLeftBottomRadius = typedArray.getFloat(R.styleable.RShapeTextView_shapeTvLeftBottomRadius, DEF_VALUE_FLOAT)
        val shapeRightBottomRadius = typedArray.getFloat(R.styleable.RShapeTextView_shapeTvRightBottomRadius, DEF_VALUE_FLOAT)
        typedArray.recycle()
