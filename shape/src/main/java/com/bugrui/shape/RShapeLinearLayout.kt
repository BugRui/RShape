...
class RShapeLinearLayout @JvmOverloads constructor(
    ...
    init {
        ...
        val shapeBgColor = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlBgColor, DEF_VALUE_INT)
        val shapeStrokeSize = typedArray.getInt(R.styleable.RShapeLinearLayout_shapeLlStrokeSize, DEF_VALUE_INT)
        val shapeStrokeColor = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlStrokeColor, DEF_VALUE_INT_0)
        ...
        val shapeGradientColor1 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor1, DEF_VALUE_INT)
        val shapeGradientColor2 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor2, DEF_VALUE_INT)
        val shapeGradientColor3 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor3, DEF_VALUE_INT)
        val shapeGradientColor4 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor4, DEF_VALUE_INT)
        val shapeGradientColor5 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor5, DEF_VALUE_INT)
        val shapeGradientColor6 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor6, DEF_VALUE_INT)
        val shapeGradientColor7 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor7, DEF_VALUE_INT)
        val shapeGradientColor8 = typedArray.getColor(R.styleable.RShapeLinearLayout_shapeLlGradientColor8, DEF_VALUE_INT)
